...
<div class="w-full max-w-3xl bg-white rounded-3xl shadow-2xl px-4 md:px-10 py-10 my-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            <div class="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <input type="text" name="bookid" id="bookid" required
                       class="flex-1 w-full px-3 py-2 border border-gray-300 rounded-lg text-base focus:ring-2 focus:ring-blue-300 focus:outline-none transition bg-blue-50"/>
            </div>
            <div class="flex flex-col md:flex-row md:items-center gap-3">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <input type="file" name="bookphoto" id="bookphoto" accept="image/*" required
                       class="flex-1 w-full border border-gray-300 rounded-lg bg-white px-3 py-2 text-base focus:ring-2 focus:ring-blue-300 focus:outline-none transition"/>
            </div>
        </div>
        <button type="submit"
