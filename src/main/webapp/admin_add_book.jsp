...
<head>
    <meta charset="UTF-8" />
    <title>Add New Book - Pahana Edu Billing System</title>
...
<div class="w-full max-w-4xl bg-white rounded-3xl shadow-2xl px-10 py-10">
    <div class="flex flex-col items-center mb-10">
        <svg class="w-16 h-16 text-blue-500 mb-3" fill="none" viewBox="0 0 48 48">
        ...
        <h2 class="text-3xl font-bold text-blue-700 mb-1 text-center">Add New Book</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <input type="text" name="bookid" id="bookid" required
                       class="flex-1 px-3 py-3 border border-gray-300 rounded-lg text-base focus:ring-2 focus:ring-blue-300 focus:outline-none transition bg-blue-50"/>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <input type="file" name="bookphoto" id="bookphoto" accept="image/*" required
                       class="flex-1 border border-gray-300 rounded-lg bg-white px-3 py-2 text-base focus:ring-2 focus:ring-blue-300 focus:outline-none transition"/>
            </div>
    ...
    <div class="text-green-600 text-center font-semibold mt-6"><%= request.getAttribute("message") %></div>
    <% } else if (request.getAttribute("error") != null) { %>
    <div class="text-red-600 text-center font-semibold mt-6"><%= request.getAttribute("error") %></div>
    <% } %>

    <a href="admin_dashboard.html"
       class="block mt-10 text-blue-700 text-center font-medium hover:underline hover:text-blue-800 transition">
