...
<head>
    <meta charset="UTF-8">
    <title>Admin View Bills | Pahana Edu</title>
    ...
    <script>
        function confirmDelete(billId) {
            if (confirm("Are you sure you want to delete Bill ID " + billId + "?")) {
                ...
                form.method = 'POST';
                form.action = 'AdminDeleteBillServlet';
...
<div class="w-full max-w-6xl bg-white rounded-3xl shadow-xl px-8 py-10">
            ...
            <tr class="hover:bg-gray-100 transition border-t">
                ...
                <td class="py-2 px-4 text-center flex justify-center gap-2">
                    ...
                    <button onclick="confirmDelete(<%= billObj.getBillId() %>)"
                            class="bg-red-500 hover:bg-red-600 text-white text-sm font-semibold px-3 py-1 rounded transition">
                        Delete
                    </button>
                </td>
            </tr>
    ...
    <div class="bg-white border border-gray-200 p-6 rounded-2xl shadow-xl">
        ...
        <table class="min-w-full bg-gray-50 text-sm rounded border">
